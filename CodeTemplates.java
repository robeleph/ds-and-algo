...
class CodeTemplates {
	...
	public int twoPointersOneInput(int[] arr) {
		int left = 0;
	...
	public int twoPointersTwoInputs(int[] arr1, int[] arr2) {
		int i = 0, j = 0, ans = 0;
	...
	public String stringBuilding(char[] arr) {
	...
	public int fastAndSlowPointers(ListNode head) {
		ListNode slow = head;
		ListNode fast = head;
		int ans = 0;
	...
	public int numOfSubArrays(int[] arr, int k) {
	...
	public int graph_dfs(int[][] graph) {
		seen.add(START_NODE);
	...
	public int graph_dfs_iterative(int[][] graph) {
		Stack<Integer> stack = new Stack<>();
		Set<Integer> seen = new HashSet<>();
	...
	public int graph_bfs(int[][] graph) {
	...
	public int binarySearch_duplicate(int[] arr, int target) {
		int left = 0;
	...
	public int binarySearch_duplicateRightMost(int[] arr, int target) {
		int left = 0;
		int right = arr.length;
		while (left < right) {
			int mid = left + (right - left) / 2;
	...
	public int binarSearch_greedy(int[] arr) {
	...
	public int binarySearch_lookingForMaximum(int[] arr) {
		int left = MINIMUM_POSSIBLE_ANSWER;
		int right = MAXIMUM_POSSIBLE_ANSWER;
		while (left <= right) {
			int mid = left + (right - left) / 2;
